...
import { Loader2, Save, ArrowLeft, Plus, Heading1, List, Code, Share, Copy, Trash2, Bot, Send, X, Globe2, History } from "lucide-react";
        ...
        <div className="flex items-center gap-3">
          {lastSaved && (
            ...
            <>
              ...
              <Button
                onClick={() => router.push(`/documents/${initialDocument.id}/history`)}
                disabled={isLoading}
                size="sm"
                variant="outline"
                className="flex items-center gap-2"
